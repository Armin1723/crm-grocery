...
const StatCard = ({ title, total, data, colors, icon: Icon, loading }) => {
  ...
  return loading ? (
    ...
    <motion.div
      ...
      className="bg-[var(--color-sidebar)] rounded-xl shadow-lg p-3 px-8 w-full min-h-[200px] flex flex-col justify-between md:flex-row gap-4"
    >
      {/* Left Side - Total */}
      ...
      <div className="flex-1 min-h-[150px] flex flex-col justify-end">
        {loading ? (
          <div className="w-full h-[120px] bg-gray-300 dark:bg-gray-700 rounded-lg animate-pulse"></div>
        ) : (
