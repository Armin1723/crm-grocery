const activationMailTemplate = (company) => {
  return `<!DOCTYPE html>
   <html lang="en">
   <head>
     <meta charset="UTF-8">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Company Activation Successful</title>
     <style>
       body {
   ...
   <body>
     <div class="container">
       <h2>Congratulations on Registering Your Company, ${company?.name}!</h2>
       <p>We are thrilled to welcome you to our platform.</p>
       <p>Your premium will end on <strong>${new Date(company?.subscriptionEndDate)}</strong>.</p>
