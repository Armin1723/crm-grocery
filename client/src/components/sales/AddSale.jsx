...
const AddSale = () => {
  ...
  return (
    <div ref={salesPageRef} className="p-3 h-full overflow-y-scroll overflow-x-hidden w-full  rounded-md flex flex-col gap-2 border border-neutral-500/50 bg-[var(--color-sidebar)]">
