...
const ProductCardSmall = ({
  ...
  return (
      <div className="bg-[var(--color-card)] flex-shrink-0 w-full h-full rounded-md p-4 transition-all flex flex-col justify-between border border-neutral-500/50 min-w-fit">
        {/* Product Image */}
