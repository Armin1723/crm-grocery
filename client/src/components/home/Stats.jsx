...
const Stats = () => {
  ...
  return (
    <div className="flex-1 flex flex-col px-2 w-full">
      ...
      <div className="line-2 flex gap-3 max-sm:flex-col-reverse px-3 min-h-[50vh] py-2 my-2">
        <SalesChart />
        <div className="col w-1/4 max-sm:w-full flex flex-col max-sm:flex-col-reverse gap-4">
          ...
          <Link to='/sales/add' className="py-1.5 px-4 rounded-md bg-accent hover:bg-accentDark transition-all duration-300 flex items-center justify-center text-white gap-2">Go To Sales <FaChartLine/></Link>
          </div>
        </div>
      </div>
    </div>
