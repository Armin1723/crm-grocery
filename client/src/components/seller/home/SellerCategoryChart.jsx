...
const SellerCategoryChart = () => {
  ...
  return (
    <div className="w-full h-full min-h-[40vh] lg:min-h-fit relative flex flex-col justify-center py-3 px-4 bg-[var(--color-sidebar)] border border-neutral-500/50 rounded-md">
      ...
      {/* Legends */}
      <div className="flex overflow-x-auto items-center w-full justify-center lg:items-start lg:justify-start space-x-2">
        {data?.map((entry, index) => (
