...
const BreadCrumbNav = () => {
  ...
  return (
    <div className="flex w-full justify-start items-center gap-2 text-base font-sans breadcrumb-container px-12 max-lg:px-6 max-sm:px-3 py-3 bg-[var(--color-sidebar)]">
          <Link
            to="/"
